...
function App() {
  ...
  /*
   * This function controls the active tage
   *
      ...
      <div className="intro-container">
        ...
        <div className="text">
          ...
          <div className="notice">
           ...
           <p>We place a randomly generated ID in your browser to manage your interaction with the experiment, organize the results, and avoid duplicated participation.</p>
    ...
    function getExperiments() {
      return(
        <div className="experiments-container">
          ...
          <div className="words">
            <h1>{currentStage === 'experiments' ? questions.questions[currentTask].words.join(' ') : tutorial.questions[currentTask].words.join(' ')}</h1>
          </div>
          <div>
